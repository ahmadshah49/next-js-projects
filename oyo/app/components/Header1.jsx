...
const Header1 = () => {
  return (
    <div className='flex items-center justify-between px-12 h-20 border-b border-gray-300 '>
      ...
      <Link href={"/login"}><div className='flex font-semibold  border-l border-gray-200 h-24 items-center justify-center px-4'><span><CgProfile size={25} className='mx-2' /></span> Login/Signup</div></Link>
