...
const Header4 = () => {
    return (
        <div className="flex items-center justify-between px-8 border border-gray-300 rounded-lg">
            ...
            <div>
                    <input type="text" placeholder="e.g.,jhon@gmail.com" className="h-16 border rounded-lg px-4 outline-none" />
                    <button className="mx-4 bg-[#F25454] hover:bg-[#f04040] duration-300 h-16 px-4 rounded-lg text-white">Notify Me</button>
                </div>
        </div>
    )
}
